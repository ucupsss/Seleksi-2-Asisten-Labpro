    ...
    return (
      <main className="flex min-h-[100dvh] items-center justify-center px-4 py-8">
        <Card className="w-full max-w-md">
          <CardHeader>
            <Badge className="w-fit" variant="outline">App A</Badge>
              ...
              <>
                <p className="text-sm text-muted-foreground">
                  {session.status === "expired"
                    ? "Your App A session has expired."
                    : session.status === "revoked"
                      ? "Your App A session was revoked by the Auth Provider."
                      : "You have signed out of App A."}
                </p>
