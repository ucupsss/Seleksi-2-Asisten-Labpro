    ...
    <main className="mx-auto min-h-[100dvh] max-w-5xl px-4 py-8">
      <header className="flex flex-col gap-4 border-b pb-5 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h1 className="mt-3 text-3xl font-semibold tracking-tight">App A</h1>
          <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
            App A tidak menyimpan password. Aplikasi ini hanya mempercayai
            Auth Provider dan membuat local session sendiri setelah userinfo
            diterima.
          </p>
        </div>
      ...
      <section className="mt-6 grid gap-4 md:grid-cols-[1fr_320px]">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Status session milik App A saja.</CardDescription>
          </CardHeader>
